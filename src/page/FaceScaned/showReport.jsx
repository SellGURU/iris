        ...
        {!isLoading && (
          <div className="w-full px-4">
            ...
            {activeTab === "overall" ? (
              <div
                id="mydiv"
                className="print:min-w-[1600px] print:scale-50 print:ml-[-400px] print:mt-[-300px]"
              >
                {/* /////////////////////////////////Summary section/////////////////////// */}
                        ...
                        <div className="grid grid-cols-2 gap-y-3 mt-6 gap-1 mb-6">
                          <div className="flex flex-row w-full text-base text-left gap-6">
                            ...
                            <div className="flex flex-col text-[14px]  font-normal">
                              ...
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry.eyebrows
                                  .symmetry_text
                              }
                            </div>
                          </div>
                          ...
                          <div className="flex flex-row w-full text-base text-left gap-6">
                            ...
                            <div className="flex flex-col text-[14px]  font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry.lash_line
                                  .symmetry_text
                              }
                            </div>
                          </div>
                          ...
                          <div className="flex flex-row w-full text-base text-left gap-6">
                            ...
                            <div className="flex flex-col text-[14px] font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry
                                  .inter_limbal_opening.symmetry_text
                              }
                            </div>
                          </div>
                          ...
                          <div className="flex flex-row w-full text-base text-left gap-6">
                            ...
                            <div className="flex flex-col text-[14px]   font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry.apex_of_cheek
                                  .symmetry_text
                              }
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col text-[14px]  font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry
                                  .upper_lip_vermillion.symmetry_text
                              }
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col text-[14px] font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry
                                  .transcommissure_line.symmetry_text
                              }
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col text-[14px] font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry
                                  .lower_lip_vermillion.symmetry_text
                              }
                            </div>
                          </div>
                          ...
                          <div className="flex flex-row w-full text-base text-left gap-6">
                            ...
                            <div className="flex flex-col text-[14px]  font-normal">
                              {
                                ScanData.data.pose_analysis[0]
                                  .current_image_analysis.symmetry.chin_border
                                  .symmetry_text
                              }
                            </div>
                          </div>
                  ...
                  {resolveAllCategories().map((value, index) => {
                    return (
                      <ContentViewBox
                        key={index}
                        category={value}
                        data={resolveArrayMeasurments().filter(
                    ...
                    <div className="w-full flex">
                      <div className="relative z-20">
                        <FaceMeshView
                          width="296px"
                          height="377px"
                          dataValues={resolveArrayMeasurments()}
                          imageSrc={
                            ScanData.data.pose_analysis[0]
                              .current_image_analysis.images.input
                          }
