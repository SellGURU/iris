...
const Register = () => {
  ...
  PracticeName: Yup
    .string().required("Practice name must be alphanumeric.").max(50,'Practice Name should be  max of 50 characters').matches(/^[a-zA-Z0-9 ]*$/, 'Use only a-z, A-Z, 0-9, and spaces').matches(/^[^!@#$%^&*+=<>:;|~]*$/,'Practice name must be alphanumeric.')
  });
