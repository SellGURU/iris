...
export const Scan = () => {
    ...
    return (
        <div className="container  mx-auto flex flex-col sm:px-6 md:px-8 lg:px-10  xl:px-12  gap-5">
            ...
            {patients == 0 ? (
                    <p className="text-center text-[#606060] font-medium">No records found. <Link to="facecamera"><span
                        className="underline text-[#544BF0]">Go to face scanner page. </span></Link></p>
                )
                :
                (
