            ...
            <div className={"absolute justify-center items-center flex z-50 w-full h-1/2"}>
                <div className={"flex  flex-col justify-center items-center text-center"}>
                    <div className={"bg-white shadow-md px-4 py-6 rounded-xl w-[548px] gap-10 flex flex-col justify-center items-center text-center "}>
                        ...
                        <p className={"text-lg font-normal"}>Please wait while we analyze your scan. This may take a few moments. We're extracting and
                            processing the information to provide you with accurate results. Thank you for your
                            patience!</p>
