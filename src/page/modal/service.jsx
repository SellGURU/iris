            ...
            <div className="max-w-[796px] overflow-hidden relative w-full rounded-[8px] bg-white h-[472px]">
                ...
                <div className="flex mt-6 justify-center">
                    <div className="w-[384px] text-center text-[14px]">
                        ...
                        {mode == 'ziroBundle' && <div> We regret to inform you that your bundle has Expired.To continue enjoying our services, please <span className="">extend</span> your package.</div>}
                    </div>
                </div>
